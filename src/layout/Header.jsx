...
const Logo = () => (
    <svg style={{color: styles.primaryColor}} height="32" width="32" fill="none" viewBox="0 0 48 48"
                            ...
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle variant="light" id="dropdown-basic">
                                        <img alt="User profile" className="rounded-circle" height="40" width="40"
                                             src="https://placehold.co/40x40/0d7ff2/FFFFFF?text=U"/>
                                    </Dropdown.Toggle>

                                    <Dropdown.Menu align="end">
                                        <Dropdown.Item onClick={() => navigate('/cover-letters')}>내 자소서
                                            관리</Dropdown.Item>
                                        <Dropdown.Item onClick={() => navigate('/cover-letters/upload')}>자소서
                                            업로드</Dropdown.Item>
                                        <Dropdown.Item onClick={() => navigate('/cover-letters/generate')}>AI 자소서
                                            생성</Dropdown.Item>
